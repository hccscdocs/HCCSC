function FindProxyForURL(url, host) {
    ...
    pacver = "hccsc.k12.in.us MS PAC file version 3.41PT, Oct 7th, 2016-JFH";
...
// Block Tango Access
	...
	// We want to send all Future City 2
	if (dnsDomainIs(host, "eaassets-a.akamaihd.net")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 3
	if (dnsDomainIs(host, ".gstatic.com")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 4
	if (dnsDomainIs(host, "tags.tiqcdn.com")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 5
	if (dnsDomainIs(host, ".origin.com")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 6
	if (dnsDomainIs(host, "consent.truste.com")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 7
	if (dnsDomainIs(host, "cdn.optimizely.com")) {
  	   return "DIRECT";
	} 

	// We want to send all Future City 8
	if (dnsDomainIs(host, ".youtube.com")) {
  	   return "DIRECT";
	} 

	// We want to send all PAC File Tester
	if (dnsDomainIs(host, ".thorsen.pm")) {
  	   return "DIRECT";
	} 
