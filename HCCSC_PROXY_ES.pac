function FindProxyForURL(url, host) {
    ...
    pacver = "hccsc.k12.in.us ES PAC file version 2.00P, April 14th, 2017-JFH";
...
// Allow Puffin Academy App IP Range 5 
	...
	// We want to send all Soundcloud 3
	if (dnsDomainIs(host, ".sndcdn.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all reflex 2
	if (dnsDomainIs(host, ".adobe.com")) {
  	   return "DIRECT";
	}

	// We want to send all SeeSaw
	...
	// We want to send all Padlet
	if (dnsDomainIs(host, ".padlet.com")) {
  	   return "DIRECT";
	}

	// We want to send all Padlet 2
	if (dnsDomainIs(host, ".hockeyapp.net")) {
  	   return "DIRECT";
	}

	// We want to send all Padlet 3
	if (dnsDomainIs(host, ".quantserve.com")) {
  	   return "DIRECT";
	}

	// We want to send all Padlet 4
	if (dnsDomainIs(host, "padlet.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all Padlet 6
	if (dnsDomainIs(host, ".quantcount.com")) {
  	   return "DIRECT";
	}

	// We want to send all ChatterPix
	if (dnsDomainIs(host, ".wizardschool.co")) {
  	   return "DIRECT";
	}

	// We want to send all Quizlet 2
	if (dnsDomainIs(host, ".apptimize.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all MobyMax2
	if (dnsDomainIs(host, "ortc-prd-useast1-s0004.realtime.co")) {
  	   return "DIRECT";
	}
	...
	// We want to send all Kahoot1
	if (dnsDomainIs(host, "kahoot.it")) {
  	   return "DIRECT";
	}

	// We want to send all Kahoot2
	if (dnsDomainIs(host, "d24n15hnbwhuhn.cloudfront.net")) {
  	   return "DIRECT";
	}
	...
	if (dnsDomainIs(host, "d31qbv1cthcecs.cloudfront.net")) {
  	   return "DIRECT";
	}

	// We want to send all Canvas 010417
	if (dnsDomainIs(host, "dashboard.buddybuild.com")) {
  	   return "DIRECT";
	}

	// We want to send all Canvas 010417
	if (dnsDomainIs(host, ".edu-apps.org")) {
  	   return "DIRECT";
	}

	// We want to send all Canvas 010417
	if (dnsDomainIs(host, ".crashlytics.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all Padlet 010417-3
	if (dnsDomainIs(host, ".mathjax.org")) {
  	   return "DIRECT";
	}
	...
	// We want to send all ISTEP data
	if (dnsDomainIs(host, ".pearsonperspective.com")) {
  	   return "DIRECT";
	}

	// We want to send The Calculator
	if (dnsDomainIs(host, ".datasavannah.com")) {
  	   return "DIRECT";
	}

	// We want to send The Calculator2
	if (dnsDomainIs(host, ".applovin.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send Iditarod App
	if (dnsDomainIs(host, "d17nyizl785moj.cloudfront.net")) {
  	   return "DIRECT";
	}

	// We want to send Canvas Issue 020117
	if (dnsDomainIs(host, "i1.wp.com")) {
  	   return "DIRECT";
	}

	// We want to send Safeschools
	if (dnsDomainIs(host, ".safeschools.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send Pict Collage
	if (dnsDomainIs(host, ".adobe.io")) {
  	   return "DIRECT";
	}

	// We want to send Pict Collage2
	if (dnsDomainIs(host, ".pic-collage.com")) {
  	   return "DIRECT";
	}

	// We want to send Pict Collage3
	if (dnsDomainIs(host, ".comodoca.com")) {
  	   return "DIRECT";
	}

	// We want to send Pict Collage3
	if (dnsDomainIs(host, ".vungle.com")) {
  	   return "DIRECT";
	}

	// We want to send Pict Collage4
	if (dnsDomainIs(host, ".mediabrix.com")) {
  	   return "DIRECT";
	}

	// We want to send Pict Collage4
	if (dnsDomainIs(host, "d1g67rtd84pulb.cloudfront.net")) {
  	   return "DIRECT";
	}
	...
	// We want to send all Scorative App
	if (dnsDomainIs(host, ".socrative.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all Scorative App
	if (dnsDomainIs(host, "maxcdn.bootstrapcdn.com")) {
  	   return "DIRECT";
	}
	...
	// We want to send all LibraryPatch
	if (dnsDomainIs(host, ".librarypatch.com")) {
  	   return "DIRECT";
	}
