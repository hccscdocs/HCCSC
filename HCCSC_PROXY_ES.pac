function FindProxyForURL(url, host) {
    ...
    pacver = "hccsc.k12.in.us ES PAC file version 2.11P, Sept 29th, 2016-JFH";
...
// Check for an Canvas 54.240.14.x IP address
    	 if (isInNet(host, "54.240.14.0", "255.255.255.0")) {
        	  return "DIRECT";
     	}
